...
// FIXME: mark block as @noescape -  currently prevented by reduce() not being @noescape
public func measureNetTime(iterations: Int, samples: Int, block: () -> ()) -> Duration {
    ...
    return Duration(nanoseconds: time / numericCast(iterations))
}
